...
Private Sub Form_Load()
    ...
    Open "c:\phonebook\help.phone" For Input As 1
...
ErrorHandler:
    ...
    Case 53
        lblText.Caption = "Your Help File Could Not Be Found, Please Re-Install PhoneBook Or Locate The Help File On Your Computer and Make Sure That It Is Named 'help.phone' and is in the same folder as PhoneBook.exe."
    End Select
End Sub
